...
// _renderNextWorkout now lives in the split-out next-card.js sub-file.
const WORKOUT_JS_PATH = path.join(REPO_ROOT, 'web/static/js/features/workout/next-card.js');
