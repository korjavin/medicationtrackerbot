...
const ALLOWED = new Map([
    ...
    [
        'web/static/js/features/food/log.js:1147',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted by the saveFoodLog optimistic-update conversion (Plan 2026-05-17 Task 4).",
    ],
    [
        'web/static/js/features/food/log.js:1148',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted by the saveFoodLog optimistic-update conversion (Plan 2026-05-17 Task 4).",
    ],
    [
