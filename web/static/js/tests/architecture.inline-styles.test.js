...
const ALLOWED = new Map([
    ...
    [
        ...
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Carried over from features/food.js:2528 after the 2026-05-13 food.js → food/log.js split; line shifted again by the CacheKeys-registry migration in features/food/log.js.",
    ],
    [
        'web/static/js/features/food/log.js:1034',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Carried over from features/food.js:2529 after the 2026-05-13 food.js → food/log.js split; line shifted again by the CacheKeys-registry migration in features/food/log.js.",
    ],
    [
