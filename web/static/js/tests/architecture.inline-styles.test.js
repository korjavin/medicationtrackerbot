...
const ALLOWED = new Map([
    ...
    [
        'web/static/js/features/food.js:2498',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted after the fourth-pass review fix that decouples the food badge offline tone from meta.isStale.",
    ],
    [
        'web/static/js/features/food.js:2499',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted after the fourth-pass review fix that decouples the food badge offline tone from meta.isStale.",
    ],
    [
