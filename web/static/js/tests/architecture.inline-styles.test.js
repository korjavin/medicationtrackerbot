...
const ALLOWED = new Map([
    ...
    [
        'web/static/js/features/food.js:2118',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted after close-X removal trimmed renderFoodModalIcons.",
    ],
    [
        'web/static/js/features/food.js:2119',
        "legacy renderFoodTargetProgress (week/2-week aggregation view) — paper-era path not targeted by Phase 4 (daily-total rewrite); slated for a follow-up phase alongside the remaining .food-target-* CSS. Line shifted after close-X removal trimmed renderFoodModalIcons.",
    ],
    [
