...
//
// Persists the current step ("welcome" | "permissions" | "integrations"
// | "done") to sessionStorage so a mid-flow process kill (Capacitor
...
(function () {
    ...
    const VALID_STEPS = Object.freeze(['welcome', 'permissions', 'integrations', 'done']);
