...
export const CLOUD_EXTRA = [
  ...
  },
  {
    ...
    response_summary: 'Object {exercises: [...]}. Each entry has exercise_id, exercise_name, variant_id, rule {type, increment_kg, ...}, training_goal (the effective goal: the exercise override, else its routine\'s), effort (the top, hardest-rated work set of the source log as "RPE 8 · 2 RIR", or null when no RPE was logged), current {target_sets, target_reps_min, target_reps_max, target_weight_kg}, proposed (same shape, with the rule applied), and changed (boolean — whether proposed differs from current). changed:false means the rep target was missed, not that the effort was too easy. An empty exercises array means no rule-carrying exercise has a completed log to project from.',
