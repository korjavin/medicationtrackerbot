...
export const PRIVACY_MANIFEST = [
  ...
  // ==========================================================================
  {
    ...
    boundary: 'not-a-carve-out',
    data: 'Meal and activity descriptions, meal photos, exercise names you ask it to tag by muscle group, Telegram assistant messages and their tool results, Journey narration summaries, plus a health-data-free model-list request when you press "Load models" in Settings',
    ...
    evidence: ['web/cloud/js/aiclient.js:18', 'web/cloud/js/aiclient.js:382', 'web/cloud/js/aiclient.js:140', 'web/cloud/js/aiclient.js:550'],
    code: { go: [], hosts: ['api.openai.com'] },
    docSignal: 'Meal descriptions + photos (AI parsing)',
    userCopy: {
      category: 'leaves',
      title: 'AI meal parsing with your own key',
      detail: 'When you use your own OpenAI-compatible key, meal descriptions, photos, workout descriptions, exercise names you ask it to tag and assistant conversations go straight from your browser to that provider — never proxied through the operator. The "Load models" button in Settings uses the same direct connection, and sends no health data at all.',
    },
  },
  {
