...
export const PRIVACY_MANIFEST = [
  ...
  // ==========================================================================
  {
    ...
    data: 'The time a reminder fires, and an opaque blob; the payload is app-layer encrypted under the push key on top of RFC 8291',
    ...
    byo: 'n/a',
    evidence: ['internal/cloudserver/push.go:215', 'internal/cloudserver/relay.go:88'],
    ...
    userCopy: {
      ...
      detail: 'A reminder is a blind alarm clock: the server knows a reminder is due at a time, but its content stays sealed. Your push subscription endpoint also tells the operator which browser vendor you use, and that vendor sees the ciphertext and its timing.',
    },
  },
  {
  ...
  // ==========================================================================
  {
    ...
    boundary: 'not-a-carve-out',
    data: 'Meal and activity descriptions, meal photos, Telegram assistant messages and their tool results, Journey narration summaries',
    ...
    activationNote: 'whenever you have a key set and use an AI feature',
    byo: 'This IS the BYO path',
    evidence: ['web/cloud/js/aiclient.js:17', 'web/cloud/js/aiclient.js:295'],
    code: { go: [], hosts: ['api.openai.com'] },
    docSignal: 'Meal descriptions + photos (AI parsing)',
    userCopy: {
      category: 'leaves',
      title: 'AI meal parsing with your own key',
      detail: 'When you use your own OpenAI-compatible key, meal descriptions, photos, workout descriptions and assistant conversations go straight from your browser to that provider — never proxied through the operator.',
    },
  },
  {
