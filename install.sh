...
# Build compose file
{
  ...
  if $ENABLE_LITESTREAM; then
    ...
    printf "        levels:\n"
    printf "          - interval: \$\${LITESTREAM_LEVEL_1_INTERVAL:-1h}\n"
    ...
    printf "        l0-retention: \$\${LITESTREAM_L0_RETENTION:-30m}\n"
    printf "        l0-retention-check-interval: \$\${LITESTREAM_L0_RETENTION_CHECK_INTERVAL:-1h}\n"
    printf "        dbs:\n"
    ...
    printf "      - LITESTREAM_LEVEL_1_INTERVAL=\${LITESTREAM_LEVEL_1_INTERVAL:-1h}\n"
    ...
    printf "      - LITESTREAM_L0_RETENTION=\${LITESTREAM_L0_RETENTION:-30m}\n"
    printf "      - LITESTREAM_L0_RETENTION_CHECK_INTERVAL=\${LITESTREAM_L0_RETENTION_CHECK_INTERVAL:-1h}\n"
    printf "    depends_on:\n"
    printf "      - medtracker\n"
    printf "    networks:\n"
    if $USE_TRAEFIK; then
