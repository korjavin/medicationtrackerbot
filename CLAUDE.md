...
| Cloud onboarding wizard — **partially implemented** (vault flag + claim→app seam shipped, `WGFirstRun` mounts in cloud; screens `med-4pz.2-4` open) | [docs/onboarding-wizard.md](docs/onboarding-wizard.md) |
