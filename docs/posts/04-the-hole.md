...
So why write this? Because every product that makes this promise from a web page has the same hole, and the usual move is to wait for a researcher to find it and then call it a technicality. I would rather it sit here in the post than in the small print. A risk you can weigh is worth more than a risk tidied out of view, and {{product}} only makes sense to me if you do the weighing.
