...
**Channel:** LinkedIn only (~400 words + answer)
...
If you've read the last two posts, you should be suspicious. The record lives on my devices. The machine in the middle can't read it. And now an AI has read it?
...
Swap the "And it can't just say…" LinkedIn paragraph for the menu-only version:
...
| Rule | Result |
|---|---|
| ≤400 words | 381 as drafted (incl. the placeholder text); the placeholder swaps for a ~35-word real answer — recount after it lands |
