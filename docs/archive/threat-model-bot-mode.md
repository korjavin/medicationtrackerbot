# ARCHIVED — Telegram bot / server threat model (2026-03-14)
...
>
> Kept, unedited, as a historical record — several of its findings were
> accepted decisions still referenced by `.jules/accepted-risks.md`. Do not
> update it, and do not cite it as current.
