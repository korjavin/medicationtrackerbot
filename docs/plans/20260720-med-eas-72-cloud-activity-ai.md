...
- [ ] Run `npx vitest run` on inbox-apply + activityai + tgcommand + architecture (domain-purity, globals, cloud-tokens) — all green before next task.
