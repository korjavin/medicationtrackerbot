...
- [ ] in `web/static/js/app.js:1489`, delete the `bindClick('bp-modal-close-btn', ...)` line
- [ ] in `web/static/js/features/bp.js:39`, delete the close-gloss icon hydration block
- [ ] remove `.wg-bp-modal__close-btn` rule(s) from `web/static/css/styles.css`
- [ ] update `web/static/js/tests/modals.bp.header-actions.test.js` to assert close-X is gone
...
- [ ] in `web/static/js/features/workout.js:114`, delete the `bindClick('workout-variant-close-btn', ...)` line
- [ ] in `web/static/js/features/workout.js:168`, remove `'workout-variant-close-btn'` from the `closeBtnIds` array
- [ ] remove `.wg-workouts-variant-modal__close-btn` rule(s) from `web/static/css/styles.css`
- [ ] update `web/static/js/tests/modals.workouts-variant.header-actions.test.js`
- [ ] `pnpm test` — must pass before Task 8

### Task 8: Workout Exercise modal — remove close-X
- [ ] delete `<button id="exercise-close-btn">` in `web/static/index.html:666`
- [ ] in `web/static/js/features/workout.js:119`, delete the `bindClick('exercise-close-btn', ...)` line
- [ ] in `web/static/js/features/workout.js:169`, remove `'exercise-close-btn'` from the `closeBtnIds` array
- [ ] remove `.wg-workouts-exercise-modal__close-btn` rule(s) from `web/static/css/styles.css`
- [ ] update `web/static/js/tests/modals.workouts-exercise.header-actions.test.js`
